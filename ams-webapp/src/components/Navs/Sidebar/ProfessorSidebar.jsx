        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <List>
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={() => {navigate("/professor-classes")}}>
                        <ListItemButton
                            sx={{
                            minHeight: 48,
                            justifyContent: open ? 'initial' : 'center',
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={() => {navigate("/professor-timetable")}}>
                        <ListItemButton
                            sx={{
                            minHeight: 48,
                            justifyContent: open ? 'initial' : 'center',
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={() => {navigate(`/professor-settings/${user._id}`)}}>
                        <ListItemButton
                            sx={{
                            minHeight: 48,
                            justifyContent: open ? 'initial' : 'center',
